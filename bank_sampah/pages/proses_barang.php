...
if ($aksi == "tambah") {
    ...
    $db->input_barangbaru($kode_barang,$nama_barang,$kategori,$stok,$jmlkeluar,$keterangan);

    echo "<script>alert('Data barang tersimpan'); window.location.href='../index.php?page=datasampah';</script>";
