<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Form Jenis Sampah</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <form action="pages/proses_barang.php?aksi=tambah" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Masukan Jenis Sampah" name="nama_barang" class="form-control" required>
                            </div>
                            <!-- <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select name="kategori" class="form-control" required>
                                <option value="">Pilih Kategori</option>
                                <option value="Baru">Mentah</option>
                                <option value="Bekas">Jadi</option>
                            </select>
                        </div>
                        <!-- <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <a href='?page=datasampah' class="btn btn-default">Batal</a>
                        </div>
                        </form>
                    </div>
                    <!-- /.col-lg-6 (nested) -->
