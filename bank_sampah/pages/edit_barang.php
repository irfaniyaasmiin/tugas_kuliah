<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Edit Jenis Sampah</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
                ...
                <div class="row">
                    ...
                    <form action="pages/proses_barang.php?aksi=updatebarang" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Masukan Jenis Sampah" name="nama_barang" class="form-control" required value="<?=$row['nama_barang']?>">
                            </div>
                            <div class="form-group">
