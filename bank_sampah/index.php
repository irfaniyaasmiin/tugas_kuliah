...
// include "config/Class_Stok.php";
$st = new Class_Customer();


include_once("config/config.php");
// Mengambil kode customer
include_once("fungsi/nomatcustomers.php");
...
if (isset($_GET['hapus'])) {
    $db->hapus($_GET['id']);
    echo "<script>alert('Sampah berhasil dihapus'); window.location.href='index.php?page=datasampah';</script>";
}
?>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            if (isset($_GET['page']) && $_GET['page'] == "datasampah") {

                include_once("pages/data_barang.php");
            } else if (isset($_GET['page']) && $_GET['page'] == "sampahbaru") {

                include_once("pages/input_barang.php");
            } else if (isset($_GET['page']) && $_GET['page'] == "datacustomer") {

                include_once("pages/data_customer.php");
            } else if (isset($_GET['page']) && $_GET['page'] == "customerbaru") {

                include_once("pages/input_customer.php");
                ...
                include_once("pages/edit_customer.php");
