...
class Class_Barang
{
    ...
    function input_barangbaru($kode_barang,$nama_barang,$kategori,$stok,$jmlkeluar,$keterangan)
    {
        ...
        $sql1 = "insert into tbl_barang values('$kode_barang','$nama_barang','$kategori','$stok','$jmlkeluar','$keterangan')";
        // echo $sql1;
